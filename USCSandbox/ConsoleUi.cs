...
namespace USCSandbox
{
    internal static class ConsoleUi
    {
        ...
        public static void Usage()
        {
            ...
            Console.WriteLine($"{MutedColor}USCSandbox --scan [folder path]{Reset}");
            Console.WriteLine();
            Console.WriteLine($"{Accent}Examples{Reset}");
            Console.WriteLine($"  {MutedColor}Scan a game folder for bundles/assets:{Reset}");
            Console.WriteLine($"    USCSandbox --scan \"C:\\Game\\Game_Data\"");
